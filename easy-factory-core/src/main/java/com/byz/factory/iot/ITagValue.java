 ...
 * <b>谁来引用？</b>
 * <ul>
 *   <li><b>Equip</b> — 通过 {@link IEquipmentParameter#getActualValue()} 写入设备参数的实际值</li>
 *   <li><b>QMS</b> — SPC 分析时读取实时参数值，与 {@link IEquipmentParameter} 控制限对比</li>
 *   <li><b>MES</b> — 工序执行时读取环境参数（温度/湿度/压差）判断生产条件</li>
 * </ul>
 *
 * @author 苏政
 */
